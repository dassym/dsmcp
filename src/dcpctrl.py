'''Launcher for *dsmcp ctrl*.

:author: F. Voilat
:date: Created on 29 avril 2022
'''
...
from app.version import REQUIRED_PYTHON, REQUIRED_DAPI2  # @UnresolvedImport
...
if __name__ == '__main__':
    ...
    from app.gui.ctrl import CtrlQtApp
    application = launcher.launch(CtrlQtApp)
    try: 
        application.startUp()
