...
class Ui_BasicWindow(object):
    def setupUi(self, BasicWindow):
        ...
        self.actionReset = QtWidgets.QAction(BasicWindow)
    ...
    def retranslateUi(self, BasicWindow):
        ...
        self.actionReset.setText(_translate("BasicWindow", "Reset..."))
        self.actionReset.setToolTip(_translate("BasicWindow", "Reset the board"))
