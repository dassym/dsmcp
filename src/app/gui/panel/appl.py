...
class PanelQtApp(BaseQtApp):
    ...
    def __init__(self, app_dir, lang):
        '''Constructor'''
        BaseQtApp.__init__(self, app_dir, lang)
    ...
    def prepareSpecificCfg(self, parser):
        ...
        # autorefresh_grp.add_argument("--_autorefresh-off", dest="autorefresh_on", action="store_false", default=True, help=BaseApp.tr("Disables auto refresh on start up."))
        # autorefresh_grp.add_argument("--_autorefresh-on", dest="autorefresh_on", action="store_true", default=True, help=BaseApp.tr("Enables auto refresh on start up."))
