...
OutputDir=G:\deploy\windows
OutputBaseFilename=dsmcp-setup-lipo
SetupIconFile=G:\src\app\gui\res\img\dcp.ico
Compression=lzma
...
Source: "G:\src\app\gui\res\img\dcp.ico"; DestDir: "{app}"; Flags: ignoreversion
Source: "G:\deploy\firm\MB-30_v5_brpower-lipo_v1.54_firm.bin"; DestDir: "{%USERPROFILE}\Dassym\firm"; Flags: ignoreversion
...
Type: files; Name: "{userdesktop}/dcplipo.lnk"
...
procedure createDesktopSerialLipoIcon();
begin
  createDesktopIcon(
    ExpandConstant('{userdesktop}\dcplipo.lnk'),
    'An application for debuging Dassym board by serial communication',
    'python.exe',
    ExpandConstant(' "{app}\dcpbasic.py" -c "dsmcp.ini" --layout=lipo -S'),
    ExpandConstant('{app}'),
    ExpandConstant('{app}\dcp.ico')
  );
end;
